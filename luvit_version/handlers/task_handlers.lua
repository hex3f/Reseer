...
local NOVICE_REWARDS = {
    ...
    [85] = {
        petId = 0,
        items = {
            {id = 0x0186BB, count = 1},  -- 100027
            {id = 0x0186BC, count = 1},  -- 100028
            {id = 0x0186A1, count = 1},  -- 100001
            {id = 0x0186A2, count = 1},  -- 100002
            {id = 0x0186A3, count = 1},  -- 100003
            {id = 0x0186A4, count = 1},  -- 100004
            {id = 0x0186A5, count = 1},  -- 100005
            {id = 0x0186A6, count = 1},  -- 100006
        }
    },
    ...
    [87] = {
        petId = 0,
        items = {
            {id = 0x0493E1, count = 5},  -- 300001
            {id = 0x0493EB, count = 5},  -- 300011
            {id = 0x0493E6, count = 5},  -- 300006
        }
    },
    -- 任务88: 使用道具 - 5000金币
    [88] = {
